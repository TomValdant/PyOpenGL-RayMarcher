...
class Scene:
    ...
    def __init__(self):
        ...
        self.spheres.append(sphere.Sphere((0,8,10),20, (1,0,0), type=1, reflectivity=0))
        self.spheres.append(sphere.Sphere((30,8,10),10, (0.2,1,0.5), type=1, reflectivity=0.5))
        self.spheres[0].reflectivity = 0.77
        self.spheres.append(sphere.Sphere((-30,-10,30),20, (0.2,1,0.5), type=0, reflectivity=0.8))
